<?php
	...
	if(isset($_POST['add']))
	{
		$STH = $DBH->prepare("INSERT INTO works (employeeID, facilityID, startDate) Values (?,?,?)");
	...
	{
		$STH = $DBH->prepare("Update works set endDate=? WHERE employeeID=? AND facilityID=?");
	...
	{
		$STH = $DBH->prepare("Delete from works WHERE employeeID=? AND facilityID=?");
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <h3 align="center">Confidential for employee protection</h3>
