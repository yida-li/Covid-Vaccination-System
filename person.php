<?php
	...
	{
		$STH = $DBH->prepare("UPDATE person SET medicareID=?, SSN=?, fName=?, lName=?, address=?, city=?, province=?, email=?, citizen=?, postalCode=?, phone=?, dob=?, groupNo=? WHERE pID=?");
        ...
        $STH->bindParam(13, $_POST['group_no']);

		
		$STH->bindParam(14, $_POST['id']);
	...
	{
		$STH = $DBH->prepare("DELETE FROM person WHERE pID=$_POST[id]");
        $STH->execute();
	...
	if(isset($_POST['add']))
	{
		$STH = $DBH->prepare("INSERT INTO person (medicareID, SSN, fName, lname, address, city, province, email, citizen, postalCode, phone, dob, groupNo) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        $STH->bindParam(14, $_POST['group_no']);
		$STH->execute();
    ...
    <body>
        ...
        <div class="container">
            <?php include 'header.php' ?>
                ...
                <div class="content" style="width: 2150px">
                    <?php
						if(isset($_POST['edit']))
						{
							$STH = $DBH->query("SELECT * FROM person WHERE pID=$_POST[id]");
							$row = $STH->fetch();
                    ...
                    <?php
						...
						{
							$STH = $DBH->query("SELECT * FROM vaccination WHERE pID = $_POST[id]");
					?>
                        <div class="panel panel-primary">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-info">Infection Record</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post">
                                                            ...
                                                            <input type="submit" class="btn btn-info" value="Record" name="record">
                                                        </form>
                                                    </td>
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-6">
                                                    <form role="form" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="id">Medicare ID</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="group_no">Group No</label>
                                                            <input name="group_no" type="number" class="form-control" required>
                                                        </div>
